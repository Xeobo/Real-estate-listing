...
public class PropertyDataSource extends AbstractDataSource<Property> {
    ...
    private PropertyDataSource(){
        add(new Property(R.drawable.mm,"Milutina Milankovica 19B","200$"));
        add(new Property(R.drawable.moler,"Kralja Aleksandra 20A","300$"));
        add(new Property(R.drawable.omlad,"Nedeljka Cabrinovica 21","250$"));
        add(new Property(R.drawable.kraljam,"Rasinska 32","300$"));
        add(new Property(R.drawable.kraljicem,"Bratislave Petrovic BB","230$"));
        add(new Property(R.drawable.vojvodes,"Bulevar vojvode Misica","320$"));
